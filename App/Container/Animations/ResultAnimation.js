...
export default class ResultAnimation extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      plusPosition16: new Animated.Value(0),
      circlePosition16: new Animated.Value(0),
      circlePosition17: new Animated.Value(0),
      plusPosition17: new Animated.Value(0),
    }
  }
    ...
    Animated.loop(
      Animated.sequence([
        ...
        Animated.parallel([
          ...
          Animated.timing(this.state.circlePosition17, {
            toValue: 100,
            useNativeDriver: false,
            duration: 5000
          }),
        ...
        Animated.parallel([
          ...
          Animated.timing(this.state.circlePosition16, {
            toValue: 100,
            useNativeDriver: false,
            duration: 5000
          }),
        ...
        Animated.parallel([
          ...
          Animated.timing(this.state.plusPosition17, {
            toValue: 100,
            useNativeDriver: false,
            duration: 5000
          }),
      ...
      <View>
        ...
        },
        {
          ...
          <View style={[styles.plusCircleView]}>
            <Animated.Image source={imageCircle} style={[styles.plusCircleImage, { transform: [{ rotate: rotateImg1 }] }]} />
          </View>
        </Animated.View>

        <Animated.View style={[styles.animatedView,        //First animated view
        {
          opacity: this.state.circlePosition16.interpolate({
            inputRange: [0, 25, 50, 80, 100],
            outputRange: [0, 1, 0.3, 1, 0]
          })
        },
        {
          transform: [
            {
              translateX: this.state.circlePosition16.interpolate({
                inputRange: [0, 100],
                outputRange: [width - 10, width - 60]
              }),
            },
            {
              translateY: this.state.circlePosition16.interpolate({
                inputRange: [0, 100],
                outputRange: [0, 80]
              }),
            },
        ...
        <Animated.View style={[styles.animatedView,        //First animated view
        {
          opacity: this.state.circlePosition17.interpolate({
            inputRange: [0, 25, 50, 80, 100],
            outputRange: [0, 1, 0.3, 1, 0]
          })
        },
        {
          transform: [
            {
              translateX: this.state.circlePosition17.interpolate({
                inputRange: [0, 100],
                outputRange: [width / 2, 100]
              }),
            },
            {
              translateY: this.state.circlePosition17.interpolate({
                inputRange: [0, 100],
                outputRange: [0, 80]
              }),
            },
        ...
        <Animated.View style={[styles.animatedView,        //First animated view
        {
          opacity: this.state.plusPosition17.interpolate({
            inputRange: [0, 25, 50, 80, 100],
            outputRange: [0, 1, 0.3, 1, 0]
          })
        },
        {
          transform: [
            {
              translateX: this.state.plusPosition17.interpolate({
                inputRange: [0, 100],
                outputRange: [width, 100]
              }),
            },
            {
              translateY: this.state.plusPosition17.interpolate({
                inputRange: [0, 100],
                outputRange: [0, 80]
              }),
            },
        ...
        <Animated.View style={[styles.animatedView,        //First animated view
        {
          opacity: this.state.plusPosition16.interpolate({
            inputRange: [0, 25, 50, 80, 100],
            outputRange: [0, 1, 0.3, 1, 0]
          })
        },
        {
          transform: [
            ...
            {
              translateX: this.state.plusPosition16.interpolate({
                inputRange: [0, 100],
                outputRange: [width, width / 2]
              }),
            },
            {
              translateY: this.state.plusPosition16.interpolate({
                inputRange: [0, 100],
                outputRange: [10, 30]
              }),
            },
          ...
          transform: [
            ...
            },
            {
              translateY: this.state.circlePosition4.interpolate({
                ...
                outputRange: [height, 150, height - 300]
              }),
            },
