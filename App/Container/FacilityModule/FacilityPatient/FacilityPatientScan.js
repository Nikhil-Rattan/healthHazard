...
class FacilityPatientScan extends React.Component {
  constructor(props) {
    super(props);
  ...
  onSuccess = (e) => {
    ...
    this.props.associateValidateKitWithPatient({
      kitNo: e.data,
      PatientQrCode: this.props.recentlyAddedPatientResponse.QRCode,
  ...
  componentDidUpdate(prevProps, prevState) {
    let KitNo = this.state.kitNo;

    if (
      this.props.associateValidateKitWithPatientFailureMessage != null &&
      prevProps.associateValidateKitWithPatientFailureMessage !=
      this.props.associateValidateKitWithPatientFailureMessage
    ) {
      this.props.resetAssociateKitStates();
      ...
      prevProps.associateValidateKitWithPatientSuccessMessage !=
      this.props.associateValidateKitWithPatientSuccessMessage
    ) {
      this.props.resetAssociateKitStates();
      this.props.setScanKitPayload({ KitNo: KitNo, HasKitIntiatedIssue: false });

      NavigationService.navigateAndReset('KitSacanIntiateScreen');
    }
  }
            ...
            topContent={
              <View>
                ...
                <Text style={[styles.text, Helpers.bold]}>
                  {
                    this.props.selectedMessage[
                    'NewTester-ScanQRCodeOnTheBackOfTheTestKit'
                    ]
                  }
                </Text>
              </View>
  ...
  renderScanMode(transformStyle) {
    let IsFirstTest = this.props.route.params.IsFirstTest;
    return (
      <View style={{ flex: 1 }}>
        <View
          style={{
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              {/* Scan the QR Code on the back of the test kit. */}
            </Text>
          </View>
          <View
            style={{
...
const mapDispatchToProps = (dispatch) => ({
  ...
  setScanKitPayload: (data) =>
    dispatch(PatientProfileActions.setScanKitPayload(data)),
