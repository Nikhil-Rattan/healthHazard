...
class ManageEditTesterDetails extends ValidationComponent {
  constructor(props) {
    super(props);
    this.state = {
      IsMessageShow: false,
  ...
  componentDidMount() {
    ...
    const updatedFacilityNameInput = {
      value: this.props.route.params.itemEditDetail?.FacilityName,
    };
    const updatedEmailInput = {
      ...inputs['emailId'],
      value: this.props.route.params.itemEditDetail?.Email,
    };
    const updatedFisrtNameInput = {
      ...inputs['firstName'],
      value: this.props.route.params.itemEditDetail?.FirstName,
    };
    const updatedLastNameInput = {
      ...inputs['lastName'],
      value: this.props.route.params.itemEditDetail?.LastName,
    };
    const updatedPhoneInput = {
      ...inputs['phoneNumber'],
      value: this.props.route.params.itemEditDetail?.PhoneNo,
    };
  ...
  _CreateCertifiedTester() {
    ...
    let payload = {
      FacilityTesterId: this.props.route.params.itemEditDetail
        ?.FacilityTesterId,
      Title: 0,
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <CustomHeaderNew
          ...
          HeaderTitle={
            this.props.route.params.itemEditDetail.FirstName +
            ' ' +
            this.props.route.params.itemEditDetail.LastName
          }
...
ManageEditTesterDetails.propTypes = {
