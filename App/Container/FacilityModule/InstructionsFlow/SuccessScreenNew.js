...
class SuccessScreenNew extends ValidationComponent {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <SafeAreaView
        ...
        <Image
          ...
          resizeMode="contain"
          source={Images.InstructionSuccess}
        />
        <View
          style={{
            flexDirection: 'row',
        ...
        <Text
          ...
          {this.props.selectedMessage['SuccessScreen-SuccessScreenText']}
        </Text>
        ...
        <View style={[Helpers.bottomView, { height: 140 }]}>
          <CustomMultiButtons
            ...
            leftButtonText={
              ...
              'SuccessScreen-ViewMyTestResultsButton'
              ]
            }
            rightButtonTextStyle={[Helpers.btnText, { color: '#673ab7' }]}
            rightButtonText={
...
export default connect(mapStateToProps, mapDispatchToProps)(SuccessScreenNew);
