...
class EnterTestResult extends ValidationComponent {
  constructor(props) {
    super(props);
    this.state = {
      IsMessageShow: false,
  ...
  async _ConfirmPress() {
    ...
    const payload = {};
    payload.PatientId = this.props.scanQRCodeSuccessResonse.PatientId;
    payload.KitNo = this.props.scanQRCodeSuccessResonse.KitNo;
