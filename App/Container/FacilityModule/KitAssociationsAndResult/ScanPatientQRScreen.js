...
class ScanPatientQRScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      IsMessageShow: false,
  ...
  componentDidMount() {
    ...
    let { isCreateTest, patientData } = this.props.route.params;

    if (isCreateTest) {
      this.setState({
        IsPatientQRCodeScannedAlready: true,
        PatientId: patientData.PatientId,
        UserKey: patientData.UserKey,
      });
    }
